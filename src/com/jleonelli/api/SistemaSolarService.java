...
/**
 * Servicio que contiene los metodos utilitarios para calculos y los metodos principal
...
public class SistemaSolarService {
	 ...
	 */
	private Map<String, Integer> calcularPosicionPlaneta(Planeta planeta, Integer tiempo){
	 ...
	 */
	private boolean calcularAlineacion(Map<String, Integer> elemento1, Map<String, Integer> elemento2, Map<String, Integer> elemento3) {
   ...
   *      posicion planeta3 o Sol
	 ...
	 */
	private Float calcularPerimetroTriangulo(Map<String, Integer> planeta1, Map<String, Integer> planeta2, Map<String, Integer> planeta3) {
	 ...
	 */
	private Float calcularDistanciaPlanetas(Map<String, Integer> planeta1, Map<String, Integer> planeta2) {
	 ...
	 */
	private boolean calcularSolDentroTriangulo(Map<String, Integer> planeta1, Map<String, Integer> planeta2, Map<String, Integer> planeta3, Map<String, Integer> sol) {
	 ...
	 */
	private Float calcularAreaTriangulo(Map<String, Integer> elemento1, Map<String, Integer> elemento2, Map<String, Integer> elemento3) {
		Integer elemento1X = elemento1.get("x");
		Integer elemento1Y = elemento1.get("y");
	 ...
	 * @param planeta3
	 * 
	 * @return String con el pronostico para los proximos N años.
	 */
	public String calcularCondicionesClimaticas(Integer años, Planeta planeta1, Planeta planeta2, Planeta planeta3) {
	...
	/**
	 * Calcula las condiciones climaticas para cada dia dada una cantidad de años y 3 planetas.
	 * 
	 * @param años
	 * @param planeta1
	 * @param planeta2
	 * @param planeta3
	 * @return Mapa con el pronostico de cada dia desde el dia 0 hasta N
	 */
	public Map<String, PronosticoPorDia> calcularCondicionesClimaticasPorDia(Integer años, Planeta planeta1, Planeta planeta2, Planeta planeta3) {
	  PronosticoPorDia pronostico;
	  Map<String, PronosticoPorDia> pronosticos = new HashMap<String, PronosticoPorDia>();
    ...
    sol.put("y", 0);
      ...
      // insert pronostico
      pronostico.setEsPicoMaximoLluvia("No.");
      pronosticos.put(d.toString(), pronostico);
    }
	  
	  // update pronostico con pico de lluvia
	  pronostico = pronosticos.get(diaDePicoMaximoDeLluvia.toString());
	  pronostico.setEsPicoMaximoLluvia("Si");
	  pronosticos.put(diaDePicoMaximoDeLluvia.toString(), pronostico);
